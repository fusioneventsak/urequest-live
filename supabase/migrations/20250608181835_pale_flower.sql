/*
  # Fix Realtime Updates for Requests and Requesters
  
  1. Changes
    - Enable REPLICA IDENTITY FULL for all tables to improve realtime updates
    - Add explicit realtime policies for requests and requesters tables
    - Add indexes for better performance
    - Add constraints to ensure data integrity
    
  2. Security
    - Maintain existing RLS policies
    - Add specific policies for realtime functionality
*/
