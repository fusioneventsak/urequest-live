/*
  ...
  1. New Types
    - `realtime_connection_status` enum for tracking connection states
  
  2. New Tables
    - `realtime_connection_logs` for tracking client connection status
  
  3. Functions
    - Add cleanup function for old connection logs
